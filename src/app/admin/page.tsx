      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
        {stats.map(stat => (
          <Link key={stat.label} href={stat.href} style={{
            ...
            <div style={{
              width: '44px', height: '44px', background: `${stat.color}15`,
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.75rem', padding: '1.25rem' }}>
            {quickLinks.map(link => (
              <Link key={link.href} href={link.href} style={{
                ...
                padding: '1rem', textDecoration: 'none', transition: 'border-color 0.15s',
              }}>
                <div style={{
                  width: '36px', height: '36px', background: `${link.color}15`,
