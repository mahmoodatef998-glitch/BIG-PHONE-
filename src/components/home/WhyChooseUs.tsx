    ...
    <section className="section">
      <div className="container-site">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '3rem', alignItems: 'center' }} className="why-grid">
          {/* Left: heading */}
          <div>
            <p style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#6C5CE7', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Why Us</p>
            <h2 style={{ fontSize: 'clamp(1.75rem, 3.5vw, 2.5rem)', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1.15, marginBottom: '1rem' }}>
              ...
              <span style={{ color: '#6C5CE7' }}> wholesale</span> electronics
            </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
            {FEATURES.map((f, i) => (
              <div key={f.title} style={{
                ...
                <div style={{ width: '36px', height: '36px', background: '#F0EEFF', borderRadius: '0.625rem', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '0.875rem' }}>
                  <f.icon size={17} style={{ color: '#6C5CE7' }} />
                </div>
