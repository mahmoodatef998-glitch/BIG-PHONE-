  ...
  return (
    <div className="product-card" style={{ height: '100%' }}>
      <Link href={`/products/${product.slug}`} style={{ display: 'block', position: 'relative' }}>
        <div style={{ width: '100%', paddingBottom: '75%', position: 'relative', background: '#F8FAFC', overflow: 'hidden' }}>
          {product.images[0] ? (
            <Image
            ...
            <div style={{
              ...
              flexDirection: 'column', gap: '0.5rem', background: '#F8FAFC',
            }}>
      ...
      <div style={{ padding: '0.875rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
        {product.brand && (
          <div>
            <span style={{
              ...
              letterSpacing: '0.08em', padding: '0.125rem 0.5rem', borderRadius: '4px',
            }}>
              {product.brand.name}
            </span>
          </div>
        ...
        <Link href={`/products/${product.slug}`} style={{ textDecoration: 'none' }}>
          <h3 style={{ fontSize: '0.9375rem', fontWeight: 700, color: '#1A2332', lineHeight: 1.3, margin: 0 }}>
        ...
        {(product.storage || product.battery_health) && (
          <div style={{ display: 'flex', gap: '0.375rem', flexWrap: 'wrap' }}>
            {product.storage && (
              <span style={{ background: '#F0F4F8', color: '#4B5563', fontSize: '0.75rem', fontWeight: 500, padding: '0.1875rem 0.5rem', borderRadius: '4px' }}>
                {product.storage}
              </span>
            )}
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.125rem' }}>
          ...
          <span style={{ background: '#FFF7E6', color: '#B45309', fontSize: '0.75rem', fontWeight: 600, padding: '0.125rem 0.5rem', borderRadius: '4px' }}>
            MOQ: {product.moq}
          </span>
        </div>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginTop: 'auto', paddingTop: '0.375rem' }}>
          <Link
            ...
            style={{ flex: 1, fontSize: '0.8125rem', height: '36px', padding: '0 0.75rem' }}
          >
            Request Quote
          </Link>
          <a
            ...
            className="btn"
            style={{ background: '#ECFDF5', color: '#00A850', border: '1.5px solid #BBF7D0', width: '36px', height: '36px', padding: 0, flexShrink: 0 }}
            aria-label="WhatsApp"
          >
